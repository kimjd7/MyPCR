...
public class MainUI extends JFrame implements Handler, DeviceChange, KeyListener
{
	...
	private URL url_blueOff = getClass().getClassLoader().getResource("ledBLow.jpg");
	private URL url_blueOn = getClass().getClassLoader().getResource("ledBHigh.jpg");
	private URL url_greenOff = getClass().getClassLoader().getResource("ledGLow.jpg");
	private URL url_greenOn = getClass().getClassLoader().getResource("ledGHigh.jpg");
	private URL url_redOff = getClass().getClassLoader().getResource("ledRLow.jpg");
	private URL url_redOn = getClass().getClassLoader().getResource("ledRHigh.jpg");
